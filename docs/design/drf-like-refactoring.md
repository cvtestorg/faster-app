...
class ViewSet[ModelType, CreateSchemaType, UpdateSchemaType, ResponseSchemaType]:
    ...
    serializer_class: type[ResponseSchemaType]
    create_serializer_class: type[CreateSchemaType]
    update_serializer_class: type[UpdateSchemaType]
    ...
    def get_serializer_class(self, action: str) -> type:
        """根据操作获取序列化器类"""
        pass
